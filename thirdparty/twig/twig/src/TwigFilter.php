...
class TwigFilter
{
    ...
    public function __construct(string $name, $callable = null, array $options = [])
    {
        ...
        $this->options = \array_merge(['needs_environment' => \false, 'needs_context' => \false, 'is_variadic' => \false, 'is_safe' => null, 'is_safe_callback' => null, 'pre_escape' => null, 'preserves_safety' => null, 'node_class' => \RS_Vendor\Twig\Node\Expression\FilterExpression::class, 'deprecated' => \false, 'alternative' => null], $options);
    }
    ...
    public function getSafe(\RS_Vendor\Twig\Node\Node $filterArgs)
    {
...
\class_alias('RS_Vendor\\Twig\\TwigFilter', 'RS_Vendor\\Twig_SimpleFilter', \false);
\class_alias('RS_Vendor\\Twig\\TwigFilter', 'RS_Vendor\\Twig_Filter');
// Ensure that the aliased name is loaded to keep BC for classes implementing the typehint with the old aliased name.
\class_exists('RS_Vendor\\Twig\\Node\\Node');
