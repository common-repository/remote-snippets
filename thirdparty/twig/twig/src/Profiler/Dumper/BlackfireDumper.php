...
EOF;
    ...
    private function dumpChildren(string $parent, \RS_Vendor\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile(string $edge, \RS_Vendor\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];
...
\class_alias('RS_Vendor\\Twig\\Profiler\\Dumper\\BlackfireDumper', 'RS_Vendor\\Twig_Profiler_Dumper_Blackfire');
