 ...
 */
class IncludeNode extends \RS_Vendor\Twig\Node\Node implements \RS_Vendor\Twig\Node\NodeOutputInterface
{
    public function __construct(\RS_Vendor\Twig\Node\Expression\AbstractExpression $expr, \RS_Vendor\Twig\Node\Expression\AbstractExpression $variables = null, bool $only = \false, bool $ignoreMissing = \false, int $lineno, string $tag = null)
    {
        $nodes = ['expr' => $expr];
        if (null !== $variables) {
    ...
    protected function addTemplateArguments(\RS_Vendor\Twig\Compiler $compiler)
    {
...
\class_alias('RS_Vendor\\Twig\\Node\\IncludeNode', 'RS_Vendor\\Twig_Node_Include');
