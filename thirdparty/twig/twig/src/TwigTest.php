...
class TwigTest
{
    ...
    public function __construct(string $name, $callable = null, array $options = [])
    {
        ...
        $this->options = \array_merge(['is_variadic' => \false, 'node_class' => \RS_Vendor\Twig\Node\Expression\TestExpression::class, 'deprecated' => \false, 'alternative' => null], $options);
    }
...
\class_alias('RS_Vendor\\Twig\\TwigTest', 'RS_Vendor\\Twig_SimpleTest', \false);
\class_alias('RS_Vendor\\Twig\\TwigTest', 'RS_Vendor\\Twig_Test');
