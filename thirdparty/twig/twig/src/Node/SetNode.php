 ...
 */
class SetNode extends \RS_Vendor\Twig\Node\Node implements \RS_Vendor\Twig\Node\NodeCaptureInterface
{
    public function __construct(bool $capture, \RS_Vendor\Twig\Node\Node $names, \RS_Vendor\Twig\Node\Node $values, int $lineno, string $tag = null)
    {
        ...
        if ($this->getAttribute('capture')) {
            ...
            if ($values instanceof \RS_Vendor\Twig\Node\TextNode) {
                $this->setNode('values', new \RS_Vendor\Twig\Node\Expression\ConstantExpression($values->getAttribute('data'), $values->getTemplateLine()));
...
\class_alias('RS_Vendor\\Twig\\Node\\SetNode', 'RS_Vendor\\Twig_Node_Set');
